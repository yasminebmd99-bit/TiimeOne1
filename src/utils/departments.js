// Liste des départements français (hors DOM-TOM et Corse)
...
/**
 * Obtient les noms des départements à partir de leurs codes
 * @param {string[]} codes - Codes des départements
 * @returns {string[]} Noms des départements
 */
